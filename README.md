...
leamos downloads the file at the specified web URL and converts any HTML to plain text.

example: leamos https://www.reddit.com/r/NoStupidQuestions/comments/1t4niz/why_are_so_many_tumblr_blogs_so_unreadable/ | fmt | less 
...
locate uses a regular expression to locate files with a matching name under the current working directory.
...
path takes a space separated list of directory names of a valid directory tree and navigates and prints the full path with separators specific to the host Operating System.
